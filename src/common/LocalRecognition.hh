...
private:
    ...
    priority_queue<pair<int,string>, vector<pair<int,string>>, ComparePair> _locality_with_freq_sortedqueue;
    int _files_count = 0;
    ...
    void LocalRecognitionWithCos();
    void LocalRecognitionWithFreq();
    void mergeWorker(tuple<int, int, double> _cur);
    void LocalRecognitionWithChain();
